...
public class StaffTest {
	...
	protected void addStaff(Staff iStaff) 
	{
		...
		if (iStaff.getUserId() != null)
			mDriver.findElement(By.id("00N28000006kXGq")).sendKeys(iStaff.getUserId());
		
		//写真ID - Photo ID
		if (iStaff.getPhotoId() != null)
			mDriver.findElement(By.id("00N28000006kXGm")).sendKeys(iStaff.getPhotoId());
		
		//説明 - Description
		if (iStaff.getDescription() != null)
			mDriver.findElement(By.id("00N28000006kXGg")).sendKeys(iStaff.getDescription());
		
		//ユーザ - User
		if (iStaff.getUser() != null)
			mDriver.findElement(By.id("CF00N28000006kXGr")).sendKeys(iStaff.getUser());
		
		//会計担当 - Account
		if (iStaff.isAccount()){
			mDriver.findElement(By.id("00N28000006kXGi")).click();
		}
		
		//注文担当 - Waiter
		if (iStaff.isWaiter()){
			mDriver.findElement(By.id("00N28000006kXGj")).click();
		}
		
		//メール - Mail
		if (iStaff.getMail() != null)
			mDriver.findElement(By.id("00N28000006kXGh")).sendKeys(iStaff.getMail());
		
		//電話 - Phone
		if (iStaff.getPhone() != null)
			mDriver.findElement(By.id("00N28000006kXGl")).sendKeys(iStaff.getPhone());

		//携帯 - Mobile
		if (iStaff.getMobile() != null)
			mDriver.findElement(By.id("00N28000006kXGk")).sendKeys(iStaff.getMobile());
		
		//誕生日	- Birthday
		if (iStaff.getBirthday() != null)
			mDriver.findElement(By.id("00N28000006kXGf")).sendKeys(new SimpleDateFormat("yyyy/mm/dd").format(iStaff.getBirthday()));
		
		//郵便番号 - Postal Code
		if (iStaff.getPostalcode() != null)
			mDriver.findElement(By.id("00N28000006kXGp")).sendKeys(iStaff.getPostalcode());
		
		//住所 - Street Address
		if (iStaff.getStreet() != null)
			mDriver.findElement(By.id("00N28000006kXGe")).sendKeys(iStaff.getStreet());
	}
